"""Run Earbud policy inference on a LeRobot episode and compare future images to GT."""
...
from cosmos_policy.experiments.robot.earbud.earbud_policy import (
    CHUNK_SIZE,
    DreamTacEarbudPolicy,
    DreamTacEarbudPolicyConfig,
    prepare_camera_images,
)
from cosmos_policy.experiments.robot.earbud.future_image_eval import FutureImageEvaluationWriter
...
def _build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--output-dir", default="./earbud_future_comparisons")
    parser.add_argument(
        "--config",

...
export FRANKA_DATASET_STATS_PATH="${FRANKA_DATASET_STATS_PATH:-/share/project/yunfan/attention_data_cut_banana/cut_banana_20260321/dataset_statistics_franka.json}"
export FRANKA_T5_EMBEDDINGS_PATH="${FRANKA_T5_EMBEDDINGS_PATH:-/share/project/yunfan/attention_data_cut_banana/cut_banana_20260321/t5_embeddings.pkl}"
export FRANKA_CHUNK_SIZE="${FRANKA_CHUNK_SIZE:-20}"

CUT_BANANA_TRAIN="${CUT_BANANA_TRAIN:-/share/project/yunfan/attention_data_cut_banana/cut_banana_20260321/train}"
